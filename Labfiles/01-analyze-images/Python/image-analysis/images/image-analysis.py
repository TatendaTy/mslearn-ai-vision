...
def main():
    ...
    try:
        ...
        endpoint=ai_endpoint, # type: ignore
        credential=AzureKeyCredential(ai_key)) # type: ignore
...
'''
In this exercise, I explored some of the image analysis and manipulation capabilities of the Azure AI Vision service. 
The service also includes capabilities for detecting objects and people, and other computer vision tasks.
'''